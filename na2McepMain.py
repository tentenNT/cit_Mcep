...
template_data_list = list(mclass.readfiles(mclass.template_data_location))
test_data_list = list(mclass.readfiles(mclass.test_data_location))
print(type(template_data_list[0]))
